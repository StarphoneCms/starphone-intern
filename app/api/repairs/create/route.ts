...
export async function POST(req: NextRequest) {
  try {
    ...
    const insertData = {
      ...
      geraet_startet:        g("geraet_startet")    || null,
      daten_wichtig:         g("daten_wichtig")     || null,
      ist_reklamation:       g("ist_reklamation") === "true",
      reklamation_bezug:     g("reklamation_bezug") || null,
